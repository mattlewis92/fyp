...
angular.module('fyp.controllers', []).
    controller(
        'IndexCtrl', ['$scope', '$http', '$q', '$angularCacheFactory', 'googleSearch', 'keywords', 'crawler', 'csv', function ($scope, $http, $q, $angularCacheFactory, googleSearch, keywords, crawler, csv) {
